...
# Lab 02 
# Lab Section: 14
# Sources, people worked with, help given to: PWW: Manuel 
# your
# comments
# here
...
More_Like_Cowboy_uhh_Cringe = "cowboy joe"
print(More_Like_Cowboy_uhh_Cringe.title())
...
SG1 = 'University of Wyoming'
SG2 = '1886'
print(f"The {SG1} was founded in {SG2}")
